...
<div class="col-lg-8">
    <form method="post" action="/surattugas/{{ $surattugas->nomor }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nomor') is-invalid @enderror" id="nomor" name="nomor"
                required autofocus value="{{ old('nomor', $surattugas->nomor) }}">
            @error('nomor')
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="dosen_id">
                ...
                @if (old('dosen_id', $surattugas->dosen_id) == $dosen->id)
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('waktu') is-invalid @enderror" id="waktu" name="waktu" required
                value="{{ old('waktu', $surattugas->waktu) }}">
            @error('waktu')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('bukti') is-invalid @enderror" id="bukti" name="bukti" required
                value="{{ old('bukti', $surattugas->bukti) }}">
            @error('bukti')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <button type="submit" class="btn btn-primary">Edit Surat Tugas</button>
    </form>
</div>
