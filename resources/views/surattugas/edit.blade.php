        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="peran_id">
                    @foreach ($peran as $p)
                    <option value="{{ $p->id }}" {{ old('peran_id', $surattugas->peran_id) == $p->id ? 'selected' : '' }}>{{ $p->nama }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="publikasi_id">
                    ...
                    <option value="{{ $p->id }}" {{ old('publikasi_id', $surattugas->publikasi_id) == $p->id ? 'selected' : '' }}>{{ $p->jenis }}</option>
                    @endforeach
                </select>
            </div>
        </div>
